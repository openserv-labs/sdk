...
function convertJsonSchemaToZod(jsonSchema: Record<string, unknown>): z.ZodTypeAny {
  try {
    ...
    const generated = new Function('z', `return ${zodSchemaString}`)(z)

    // Ensure result is a Zod object; fallback otherwise
    return generated instanceof z.ZodObject ? generated : z.object({}).passthrough()
  } catch (error) {
    return z.object({}).passthrough()
  }
}
